...
class VKAuth(object):
    ...
    def _get_params(self):
        ...
        # Typical error
        if self.response.url == 'https://oauth.vk.com/error?err=2':
            print('Security error. Perhaps the error disappears if'
                  + ' you relogin in the browser.')
        ...
        try:
            ...
            print('Coudln\'t fetch token and user id from url:')
